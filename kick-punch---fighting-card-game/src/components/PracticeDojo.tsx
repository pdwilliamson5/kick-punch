...
import { UNIVERSAL_BASIC_MOVES } from '../data/moves';
...
export const PracticeDojo: React.FC = () => {
  ...
  const [p1Move, setP1Move] = useState<CombatCard>(UNIVERSAL_BASIC_MOVES[0]); // Jab
  const [p2Move, setP2Move] = useState<CombatCard>(UNIVERSAL_BASIC_MOVES[1]); // Hook
