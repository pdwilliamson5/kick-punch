...
// Firebird Art
import firebirdJabArt from '../assets/images/firebird_jab_art_1787804816757.jpg';
import firebirdHookArt from '../assets/images/firebird_hook_art_1787804835766.jpg';
import firebirdFrontKickArt from '../assets/images/firebird_front_kick_1787804851967.jpg';
import firebirdRoundhouseArt from '../assets/images/firebird_roundhouse_1787804870871.jpg';
import firebirdHighBlockArt from '../assets/images/firebird_high_block_1787804899617.jpg';
import firebirdLowBlockArt from '../assets/images/firebird_low_block_1787804918249.jpg';
import firebirdJumpArt from '../assets/images/firebird_jump_art_1787804937609.jpg';
import firebirdReverseArt from '../assets/images/firebird_reverse_art_1787804954449.jpg';
import firebirdSunbirdFinisher from '../assets/images/firebird_sunbird_finisher_1787804970707.jpg';
import firebirdCardSheet from '../assets/images/firebird_card_sheet_1787804799991.jpg';

// Tidal Wave Art
import tidalJabArt from '../assets/images/tidal_jab_art_1787805021575.jpg';
import tidalHookArt from '../assets/images/tidal_hook_art_1787805037941.jpg';
import heroTidalImg from '../assets/images/hero_tidal_card_1787802366091.jpg';
import tidalCardSheet from '../assets/images/tidal_card_sheet_1787804989048.jpg';
...
export {
  ...
  firebirdJabArt,
  firebirdHookArt,
  firebirdFrontKickArt,
  firebirdRoundhouseArt,
  firebirdHighBlockArt,
  firebirdLowBlockArt,
  firebirdJumpArt,
  firebirdReverseArt,
...
export const FIREBIRD_BASIC_MOVES: CombatCard[] = UNIVERSAL_BASIC_MOVES.map((card) => {
  let img = firebirdJabArt;
  if (card.moveNumber === 1) img = firebirdJabArt;
  else if (card.moveNumber === 2) img = firebirdHookArt;
  else if (card.moveNumber === 3) img = firebirdFrontKickArt;
  else if (card.moveNumber === 4) img = firebirdRoundhouseArt;
  else if (card.moveNumber === 5) img = firebirdHighBlockArt;
  else if (card.moveNumber === 6) img = firebirdLowBlockArt;
  else if (card.moveNumber === 7) img = firebirdJumpArt;
  else if (card.moveNumber === 8) img = firebirdReverseArt;
...
export const TIDAL_BASIC_MOVES: CombatCard[] = UNIVERSAL_BASIC_MOVES.map((card) => {
  let img = tidalJabArt;
  if (card.moveNumber === 1) img = tidalJabArt;
  else if (card.moveNumber === 2) img = tidalHookArt;
  else if (card.moveNumber === 3) img = tidalJabArt; // front kick with water
  else if (card.moveNumber === 4) img = tidalHookArt; // roundhouse
  else if (card.moveNumber === 5) img = heroTidalImg; // high block
  else if (card.moveNumber === 6) img = heroTidalImg; // low block
  else if (card.moveNumber === 7) img = tidalJabArt; // jump
  else if (card.moveNumber === 8) img = tidalHookArt; // reverse
...
export const CHAD_BASIC_MOVES: CombatCard[] = [...UNIVERSAL_BASIC_MOVES];

export const getFighterMoves = (fighterId: string): CombatCard[] => {
  if (fighterId === 'firebird') return FIREBIRD_BASIC_MOVES;
  if (fighterId === 'tidal_wave') return TIDAL_BASIC_MOVES;
  return CHAD_BASIC_MOVES;
};
